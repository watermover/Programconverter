...
namespace TranslatePrograms.Models
{
    ...
    public class ScannerPascalToPython:IScanner
    {
        const char EOL = '\n';
        ...
        public ScannerPascalToPython(string fileName)
        {
            try
            {
        ...
        public ScannerPascalToPython(Stream s)
        {
