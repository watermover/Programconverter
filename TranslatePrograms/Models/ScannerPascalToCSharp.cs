...
namespace TranslatePrograms.Models
{
    ...
    // Scanner
    //-----------------------------------------------------------------------------------
    public class ScannerPascalToCSharp:IScanner
    {
        const char EOL = '\n';
        ...
        public ScannerPascalToCSharp(string fileName)
        {
            try
            {
        ...
        public ScannerPascalToCSharp(Stream s)
        {
