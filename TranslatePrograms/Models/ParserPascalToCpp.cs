...
namespace TranslatePrograms.Models
{
    ...
    public class ParserPascalToCpp:IParser
    {
        ...
        public ScannerPascalToCpp scanner;
        ...
        public ParserPascalToCpp(ScannerPascalToCpp scanner)
        {
